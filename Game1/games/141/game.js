...
(function(t) {
    ...
    function m(t) {
        var e, n, i, a = !1,
            r = [];
        if ("string" == typeof t && (r = t.split("|"), "gameapi" === r[0])) {
            r.shift(),
                e = r.shift(),
    ...
    "filter" in Array.prototype || (Array.prototype.filter = function(t, e) {
        for (var n, i = [], a = 0, r = this.length; r > a; a++) a in this && t.call(e, n = this[a], a, this) && i.push(n);
        return i
    }),
        ...
        function(t) {
            ...
            function d() {
                ...
                var e, n = [],
                    ...
                    a = Z(d.prototype),
                    r = Z(g.prototype);
                if (r.promiseDispatch = function(t, a, r) {
                        var s = K(arguments);
                        n ? (n.push(s), "when" === a && r[1] && i.push(r[1])) : u.nextTick(function() {
            ...
            function g(t, e, n) {
                ...
                if (i.promiseDispatch = function(n, a, r) {
                        var s;
                        try {
                            s = t[a] ? t[a].apply(i, r) : e.call(i, a, r)
                        } catch(o) {
                            s = E(o)
                        }
                        n && n(s)
            ...
            function T(t, e) {
                oe && ("object" == typeof process && "function" == typeof process.emit && u.nextTick.runAfter(function() { - 1 !== $(re, t) && (process.emit("unhandledRejection", e, t), se.push(t))
                }), re.push(t), e && e.stack !== void 0 ? ae.push(e.stack) : ae.push("(no stack) " + e))
            }
            function b(t) {
                if (oe) {
                    var e = $(re, t); - 1 !== e && ("object" == typeof process && "function" == typeof process.emit && u.nextTick.runAfter(function() {
                        var n = $(se, t); - 1 !== n && (process.emit("rejectionHandled", ae[e], t), se.splice(n, 1))
                    }), re.splice(e, 1), ae.splice(e, 1))
                }
            }
            function E(t) {
                var e = g({
                ...
                return function() {
                    function e(t, e) {
                        ...
                        if ("undefined" == typeof StopIteration) {
                            ...
                            return s.done ? u(s.value) : f(s.value, a, r)
                        }
                        try {
                            s = i[t](e)
                        } catch(o) {
                ...
                return f(t,
                    function(t) {
                        ...
                        return z(t,
                            function(i, a, r) {
                                var s;
                                y(a) && "fulfilled" === (s = a.inspect()).state ? t[r] = s.value: (++e, f(a,
                                    function(i) {
                                        t[r] = i,
                                        0 === --e && n.resolve(t)
                                    },
            ...
            var B, J, V = l(),
                ...
                X = function() {
                    ...
                    if (X = function(t) {
                        ...
                        "object" == typeof process && "[object process]" == "" + process && process.nextTick) s = !0,
                        r = function() {
                            process.nextTick(t)
                        };
                ...
                u.nbind = function(t, e) {
                    ...
                    return function() {
                        ...
                        var a = n.concat(K(arguments)),
                            r = d();
                        return a.push(r.makeNodeResolver()),
                            u(i).fapply(a).fail(r.reject),
                            r.promise
                    }
                },
    ...
    _.argsToArray = function(t) {
        ...
        _.callConfigar = function(t, e) {
            ...
            s && (i = ["configs", r, a, s].join("/"), n.open("GET", i, !0), n.timeout = 3e3, n.ontimeout = function() {
                e(404, null)
            },
                n.send())
        },
                ...
                n = {
                    ...
                    send: function(i) {
                        var a = n.set.callback || 0,
                            r = n.set.data || 0; (i || a || r) && (t += /\?/.test(t) ? "&": "?", i && (t += r ? r + "=" + encodeURIComponent(i) : i, a && (t += "&")), a && (t += a + "=" + e));
        ...
        _.xdr = function(t, e) {
            var n, i, a = t.url || "",
                r = (t.type || "GET").toUpperCase(),
                s = void 0 !== t.data ? t.data: {},
                o = t.headers || {},
                l = function() {
                    e({
                        isError: !0
    ...
    A.getGameConfig = function() {
                ...
                t && t.id ? _.callConfigar(t,
                    function(n, a) {
                        if (200 === n && "string" == typeof a && JSON.parse(a)) {
                            var r = JSON.parse(a),
                                s = A.configFromData(t);
                            s.branding = r.configar && r.configar.branding ? r.configar.branding: i.configar.branding,
                                e.call(this, s)
                        } else e.call(this, {
                            isLocal: !0,
        ...
        n.prototype.put = function(t, e) {
            for (var n = this.dataStore,
                     i = t.split("."), a = i.length, r = 0; a - 1 > r; r++) {
                var s = i[r];
                n[s] || (n[s] = {}),
                    n = n[s]
            }
        ...
        i.prototype._getAppToken = function() {
            ...
            this.IS_MASTER && ("function" == typeof SpilGames ? SpilGames("api.account.getApplicationToken", {
                ...
                function(e) {
                    e.error || !e.appAuth.token ? t._postMessage({},
                        void 0, "gameapi.apptoken.getAppTokenResponse") : t._postMessage({
                            appToken: e.appAuth.token,
                            level: e.level
                        },
        ...
        a.prototype.syncState = function() {
            ...
            for (var t, e = this.gameState.appId,
                     ...
                     r = 0, s = this, o = 0; i.length > o; o++) t = window.localStorage[i[o]],
                void 0 === t ? a.remove.push(i[o]) : (a.set[i[o]] = t, r = Math.max(t.length, r));
            if (i.length > 0) {
                var l = {
                ...
                _.xdr(l,
                    function(t) {
                        t.isError ? s.retrySyncState("GameAPIGameState error syncing state") : (_.log("GameAPIGameState synced " + i.length + " keys"), s.resetDelaySyncState(), s.gameState.dirtyKeys = [])
                    });
                var p = {
                    numkeys: i.length,
                    maxdatalength: r,
        ...
        s.prototype.getLocalizedText = function() {
            if (!this.moduleReady) throw Error("This method cannot be called before the API is loaded");
            return key
        },
        ...
        d.prototype._runCallback = function(t) {
            this._callbacks[t] && (this._callbacks[t](), this._callbacks[t] = !1)
        },
        d.prototype.isAvailable = function() {
            var t = !1;
            return this.data && this.data.portal && this.data.portal.siteId && 500 > this.data.portal.siteId && (t = !0),
                t
        },
        d.prototype.reward = function(t, e) {
        ...
        d.prototype._onAdAccepted = function(t) {
            var e = this.messenger;
        ...
        c.prototype._validateEvent = function(t) {
            var e = !1;
        ...
        h.prototype._sendSETEvent = function(t, e, n) {
            return this.IS_STANDALONE ? _.submitData("http://logs.spilgames.com/lg/pb/1/ut/", e, n) : this.messenger && this.messenger.post("tracker.event." + t, e, n),
                e
        },
        h.prototype.trackGamePlay = function(t) {
            ...
            this.data && this.data.branding && this.data.branding.logo && this.data.branding.logo.image && (s = !1);
        ...
        g.prototype._tagUrl = function(t, e) {
            ...
            return n = "string" == typeof e ? e: "logo",
                ...
                a = ["utm_medium=" + i, "utm_campaign=" + s.applicationId, "utm_source=" + r.host, "utm_content=" + n].join("&"),
                t += t.indexOf("?") > -1 ? "&": "?",
            t + a
        },
    ...
    y.prototype._postMessage = function(t, e, n) {
        ...
        for (var r = 0; this._targets.length > r; r++) this._targets[r].postMessage(a, "*")
    },
    ...
    y.prototype._handleMessage = function(t) {
        var e, n, i, a, r = this,
            s = new f(t.data);
        if (s) if (e = s.type, n = s.callbackId, i = s.data, a = this._callbacks[n] || !1, this.IS_MASTER) switch (e) {
            case "jslib":
    ...
    y.prototype._handleUGARequest = function(t) {
        var e, n, i, a = this,
            r = new f(t.data);
        if (r) switch (e = r.data[0], n = r.callbackId, i = r.data[1] ? r.data[1] : null, e) {
            case "GameAPI.data":
    ...
    v.prototype.loadAPI = function(t, e) {
        ...
        function o() {
            p.__.messenger.requestFromParent("GameAPI.isReady", {},
                function(t) {
                    l && clearTimeout(l),
                        t.isready ? r() : 5 > d ? (d++, setTimeout(o, 500)) : (_.log("GameAPI:checkMasterReady not ready but reached max wait"), r())
                })
        }
        var l, p = this,
        ...
        return ! 0 === this.isReady ? (_.log("WARNING: Detected multiple executions of GameAPI.loadAPI(). This method should only be executed once per page load!"), t(p)) : (this.__.messenger._postMessage(["log.gameapi.loadapi.start", {
            ...
            null], null, "log"), this.IS_STANDALONE ? s() : this.IS_MASTER ? A.getGameConfig().then(function(t) {
            A.getBrandingConfig(t).then(function(e) {
                t && !t.isError ? (t.branding = e.branding, p.__.dataStore._setCache(a(t))) : _.log("GameAPI gameConfig error: ", t.isError),
                    i(t)
            })
        }) : e && e.gamestate ? i(A.configFromData(e)) : (l = setTimeout(s, 600), o()), void 0)
    };
    var w = new v(n, y, g, h, d);
    "function" == typeof define && define.amd && define("GameAPI", w),
        t.GameAPI = w
})(window),
    function() {
        "use strict";
